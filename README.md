...
Display colors visually in a palette layout

Show corresponding hex color values
...
JavaScript (ES6) – randomization and DOM updates
...
Color values are applied dynamically to UI elements

Hex codes are updated in real time with each generation

UI re-renders on user interaction
